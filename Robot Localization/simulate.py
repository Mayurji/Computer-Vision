...
class Simulation(object):
	...
	def show_beliefs(self, past_turn=False):
		...
		if past_turn:
			...
			plt.scatter([self.prev_pose[1]], [self.height-self.true_pose[0]-1],
			            color='red', marker="*", s=200, alpha=0.3)
		plt.scatter(self.X, self.Y, s=self.P, color="blue")
		plt.scatter([self.true_pose[1]], [self.height-self.true_pose[0]-1],
	...
	def random_move(self):
		...
		print("dy value is ",dy, "dx value is ", dx)
		return dy, dx
